...
class SaySize(Action):
    def name(self) -> Text:
        return "action_say_size"
...
class ActionSetSlotInterested(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if  flag_form:
            ...
            if (intent in true_intents) or (intent in papyrus_intents):
...
class ActionSetSlotPapyrusIntents(Action):
    def name(self):
        return "action_set_slot_papyrus_intents"  
...
class ActionValidateAction(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain):
        ...
        # if (intent in papyrus_intents) or (intent=="intent_exhibit") or (intent=="intent_affirm"):

        slot_interested = tracker.slots.get("slot_interested")
        
        if  (slot_interested==None): 
                        
            bot_response = "In my free time, I stand here and give our visitors information about the Papyrus of Derveni."
            dispatcher.utter_message(text=bot_response)
