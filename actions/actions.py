...
class ActionSetSlotInterested(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        true_intents = ["intent_affirm", "intent_whatever", "intent_exhibit", "intent_no_change_exhibit"]
        papyrus_intents = tracker.slots.get("slot_papyrus_intents")
...
class ActionReactToSilence(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if (requested_slot!=None):
            ...
            #     return [UserUtteranceReverted(),  SlotSet("slot_silence_count",silence_count), SlotSet("slot_list_exhibit_utters",exhibit_utters)]
