...
class Saydating(Action):
    def name(self) -> Text:
        return "action_say_dating"
...
class Sayacquisition(Action):
    def name(self) -> Text:
        return "action_say_acquisition"
...
class ValidateForm(FormValidationAction):
    ...
    def validate_slot_age(
        ...
        if slot_value == 3:
            grade="be in kindergarden"
        elif slot_value == 4:
            grade="be in kindergarden"
        elif slot_value == 5:
            grade="be in kindergarden"
        elif slot_value == 6:
            grade="be in the first grade of primary school"
        elif slot_value == 7:
            grade="be in the second grade of primary school"
        elif slot_value == 8:
            grade="be in the third grade of primary school"
        elif slot_value == 9:
            grade="be in the fourth grade of primary school"
        elif slot_value == 10:
            grade="be in the fifth grade of primary school"
        elif slot_value == 11:
            grade="be in the sixth grade of primary school"
        elif slot_value == 12:
            grade="be in the first grade of secondary school"
        elif slot_value == 13:
            grade="be in the second grade of secondary school"
        elif slot_value == 14:
            grade="be in the third grade of secondary school"
        elif slot_value == 15:
            grade="be in the first grade of high school"
        elif slot_value == 16:
            grade="be in the second grade of high school"
        elif slot_value == 17:
            grade="be in the third grade of high school"
        elif slot_value>=18:
            grade="be a school graduate"
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain):
        ...
        if tracker.active_loop.get("name")=="form_user":                
            ...
            if requested_slot=="slot_name":
                ...
                wreath_intents = tracker.slots.get("slot_wreath_intents")
                if intent in wreath_intents:
                   return []
...
class ActionSetSlotInterested(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if  flag_form:
            ...
            if (intent in true_intents) or (intent in wreath_intents):
...
class ActionSubmitFormExhibit(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain):
        ...
        if (intent in wreath_intents) and (flag_exhibit_utters!="2"): #an rwtise kati autos kai den eimast stin prwti fora
...
class ActionSetSlotwreathIntents(Action):
    def name(self):
        return "action_set_slot_wreath_intents"  
...
class ActionValidateAction(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain):
        ...
        # if (intent in wreath_intents) or (intent=="intent_exhibit") or (intent=="intent_affirm"):

        slot_interested = tracker.slots.get("slot_interested")
        
        if  (slot_interested==None): 
                        
            bot_response = "In my free time, I stand here and give our visitors information about the Golden Myrtle Wreath."
            dispatcher.utter_message(text=bot_response)
